...
# 🔹Esclarecimento das Possíveis ->Dúvidas<- que Surgiram até agora sobre os Registradores no Projeto Didático 
...
| **R1,R2,R3** | Armazenar dados de propósito geral | Fonte de valores para mover ou carregar no AUX |
